...
namespace BuildLogReporter.UnitTests.Processors
{
    ...
    public sealed class BinaryLogProcessorTests
    {
        ...
        public void CountAndGetErrorsAndWarnings_WhenParsingBinlogWithErrors_ShouldReturnCorrectTuple(bool verbose)
        {
            ...
            // Act
            (bool success, ushort actualErrorCount, ushort actualWarningCount, ReadOnlyCollection<LogEntry> logEntries) = binaryLogProcessor.CountAndGetErrorsAndWarnings(projectWithErrorsBinlogPath, verbose);
        ...
        public void CountAndGetErrorsAndWarnings_WhenParsingBinlogWithErrorsAndWarnings_ShouldReturnCorrectTuple(bool verbose)
        {
            ...
            // Act
            (bool success, ushort actualErrorCount, ushort actualWarningCount, ReadOnlyCollection<LogEntry> logEntries) = binaryLogProcessor.CountAndGetErrorsAndWarnings(projectWithErrorsAndWarningsBinlogPath, verbose);
        ...
        public void CountAndGetErrorsAndWarnings_WhenParsingBinlogWithoutErrorsOrWarnings_ShouldReturnCorrectTuple(bool verbose)
        {
            ...
            // Act
            (bool success, ushort actualErrorCount, ushort actualWarningCount, ReadOnlyCollection<LogEntry> logEntries) = binaryLogProcessor.CountAndGetErrorsAndWarnings(projectWithoutErrorsOrWarningsBinlogPath, verbose);
        ...
        public void CountAndGetErrorsAndWarnings_WhenParsingBinlogWithWarnings_ShouldReturnCorrectTuple(bool verbose)
        {
            ...
            // Act
            (bool success, ushort actualErrorCount, ushort actualWarningCount, ReadOnlyCollection<LogEntry> logEntries) = binaryLogProcessor.CountAndGetErrorsAndWarnings(projectWithWarningsBinlogPath, verbose);
